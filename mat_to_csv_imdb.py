...
# --- photo taken ---
photo_taken_rec = mat['imdb'][0][0][1][0]
# ---

# --- full_path ---
for fp in mat['imdb'][0][0][2][0]:
...
# --- gender ---
gender_rec = mat['imdb'][0][0][3][0]
# ---

# --- name ---
for name in mat['imdb'][0][0][4][0]:
    if name:
...
# --- face_score ---
face_score_rec = mat['imdb'][0][0][6][0]
# ---

# --- second_face_score ---
second_face_score_rec = mat['imdb'][0][0][7][0]
# ---
